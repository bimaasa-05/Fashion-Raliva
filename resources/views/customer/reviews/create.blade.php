...
<h1 class="font-display-lg text-headline-md tracking-widest text-on-surface dark:text-on-surface uppercase flex-1 text-center truncate max-w-[240px]">Write Review</h1>
