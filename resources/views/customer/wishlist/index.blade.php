...
<!-- Wishlist (Active) -->
<a class="flex flex-col items-center justify-center gap-1 w-16 h-full text-[var(--chrome-accent)]" href="{{ route('customer.login', ['redirect' => route('customer.wishlist')]) }}">
<span class="material-symbols-outlined text-[24px]" data-icon="favorite" data-weight="fill">favorite</span>
