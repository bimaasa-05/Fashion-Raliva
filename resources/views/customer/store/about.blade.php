...
<style>
    ...
    .info-row .material-symbols-outlined { color: var(--chrome-accent); }
  </style>
  </head>
...
<div class="min-w-0">
<p class="font-body-sm text-body-sm font-semibold text-on-surface">{{ __('Business Hours') }}</p>
<p class="font-body-sm text-body-sm text-on-surface-variant mt-xs">{{ __('Mon - Sat') }} · 09:00 - 18:00 WIB</p>
<p class="font-body-sm text-body-sm text-on-surface-variant">{{ __('Sunday') }} · {{ __('Closed') }}</p>
</div>
</div>
</div>
<!-- Established -->
...
<h3 class="font-title-md text-title-md text-on-surface mb-md">{{ __('Store Policies') }}</h3>
