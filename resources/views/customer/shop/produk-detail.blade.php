...
<a aria-label="Wishlist" href="{{ route('login', ['redirect' => url()->current()]) }}" class="w-10 h-10 flex items-center justify-center rounded-full bg-surface-container-lowest/50 hover:bg-surface-variant transition-colors">
...
<a href="{{ route('login', ['redirect' => url()->current()]) }}" class="flex-1 h-12 border border-on-surface bg-transparent text-on-surface font-label-caps text-label-caps tracking-widest hover:bg-surface-variant transition-colors flex items-center justify-center">
            {{ __('ADD TO CART') }}
        </a>
...
<a aria-label="{{ __('Add to wishlist') }}" href="{{ route('login', ['redirect' => url()->current()]) }}" class="absolute top-2 right-2 p-2 text-on-surface hover:text-secondary transition-colors flex items-center">
