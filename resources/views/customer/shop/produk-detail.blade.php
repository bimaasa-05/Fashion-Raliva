...
<title>RALIVA - Oversized Linen Shirt</title>
...
<!-- Color Selection -->
<div class="mb-lg">
<p class="font-label-caps text-label-caps text-on-surface mb-sm">COLOR: WHITE</p>
<div class="flex gap-sm">
<button aria-label="Select White" class="w-8 h-8 rounded-full border border-on-surface p-[2px]">
<span class="block w-full h-full rounded-full bg-[#FFFFFF] border border-outline-variant"></span>
</button>
<button aria-label="Select Black" class="w-8 h-8 rounded-full border border-transparent p-[2px]">
<span class="block w-full h-full rounded-full bg-[#111111]"></span>
</button>
<button aria-label="Select Beige" class="w-8 h-8 rounded-full border border-transparent p-[2px]">
...
<p class="font-label-caps text-label-caps text-on-surface">SIZE</p>
<button class="font-label-sm text-label-sm text-on-surface-variant underline decoration-1 underline-offset-4">Size Guide</button>
</div>
...
<span class="font-title-md text-title-md text-on-surface">Description</span>
...
<details class="group border-b border-outline-variant">
<summary class="flex justify-between items-center px-container-margin py-sm cursor-pointer list-none">
<span class="font-title-md text-title-md text-on-surface">Material &amp; Care</span>
<span class="material-symbols-outlined text-on-surface group-open:rotate-180 transition-transform">expand_more</span>
</summary>
<div class="px-container-margin pb-sm">
...
<details class="group border-b border-outline-variant">
<summary class="flex justify-between items-center px-container-margin py-sm cursor-pointer list-none">
<span class="font-title-md text-title-md text-on-surface">Shipping &amp; Returns</span>
<span class="material-symbols-outlined text-on-surface group-open:rotate-180 transition-transform">expand_more</span>
</summary>
<div class="px-container-margin pb-sm">
<p class="font-body-sm text-body-sm text-on-surface-variant leading-relaxed">
                        Free standard shipping on orders over Rp 500.000. Returns accepted within 14 days of delivery. Items must be unworn with original tags attached.
                    </p>
</div>
</details>
</section>
<!-- You May Also Like -->
<section class="py-xl">
<h2 class="font-headline-md text-headline-md text-center text-on-surface mb-lg">You May Also Like</h2>
...
<button class="absolute top-2 right-2 w-8 h-8 flex items-center justify-center rounded-full bg-surface-container-lowest/50">
<span class="material-symbols-outlined text-on-surface text-[18px]">favorite_border</span>
</button>
</div>
<div class="space-y-1">
...
<a href="{{ route('customer.chart') }}" class="flex-1 h-12 border border-on-surface bg-transparent text-on-surface font-label-caps text-label-caps tracking-widest hover:bg-surface-variant transition-colors flex items-center justify-center">
            ADD TO CART
        </a>
