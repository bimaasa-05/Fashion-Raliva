...
<a href="{{ request()->query('order') ? route('customer.order-tracking', ['order' => request()->query('order')]) : route('customer.komplain') }}" aria-label="{{ __('Go back') }}" class="p-2 -ml-2 hover:opacity-70 transition-all duration-200 flex">
