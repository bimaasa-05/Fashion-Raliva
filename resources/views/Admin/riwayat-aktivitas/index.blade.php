    ...
    <section class="space-y-6">
        <div class="timeline-item relative">
            <div class="flex items-start">
                <div class="relative z-10 w-10 h-10 rounded-full bg-surface-container-high flex items-center justify-center shrink-0 border border-muted-border mt-1"><span class="material-symbols-outlined text-on-surface-variant text-sm">fact_check</span></div>
        ...
        <div class="timeline-item relative">
            <div class="flex items-start">
                <div class="relative z-10 w-10 h-10 rounded-full bg-surface-container-high flex items-center justify-center shrink-0 border border-muted-border mt-1"><span class="material-symbols-outlined text-on-surface-variant text-sm">local_shipping</span></div>
                <div class="ml-element-gap flex-grow">
        ...
        <div class="timeline-item relative">
            <div class="flex items-start">
                <div class="relative z-10 w-10 h-10 rounded-full bg-surface-container-high flex items-center justify-center shrink-0 border border-muted-border mt-1"><span class="material-symbols-outlined text-on-surface-variant text-sm">support_agent</span></div>
                <div class="ml-element-gap flex-grow">
...
@push('styles')
<style>
    .timeline-line::before { content: ''; position: absolute; left: 20px; top: 48px; bottom: -24px; width: 1px; background-color: rgb(var(--c-border)); z-index: 0; }
