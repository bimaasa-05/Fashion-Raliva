        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-gutter">
            <div class="bg-surface-container-lowest border border-muted-border rounded-lg p-6 card-premium">
                <div class="flex items-start justify-between mb-4">
                    <div>
                        <p class="font-mono text-sm text-on-surface-variant">KOM-0312 • Pesanan #RLV-2068</p>
                ...
                <div class="bg-surface-container-low border border-muted-border rounded-lg p-4 mb-4">
                    <p class="font-body-md text-sm text-on-surface-variant">"Saya order size L tapi yang datang M. Mohon solusinya, karena butuh untuk acara minggu depan." — <span class="text-on-surface font-bold">Sarah Jenkins</span></p>
                </div>
                ...
                <div class="flex gap-3">
                    <button class="flex-1 py-2.5 bg-deep-onyx text-on-primary font-label-sm text-label-sm uppercase tracking-widest rounded hover:bg-tertiary-container transition-colors btn-premium">Kirim Balasan</button>
                    <button class="flex-1 py-2.5 border border-muted-border text-on-surface font-label-sm text-label-sm uppercase tracking-widest rounded hover:bg-surface-container-low transition-colors">Eskalasi ke Owner</button>
                </div>
            </div>
            ...
            <div class="bg-surface-container-lowest border border-muted-border rounded-lg p-6 card-premium">
                <div class="flex items-start justify-between mb-4">
                    <div>
                        <p class="font-mono text-sm text-on-surface-variant">KOM-0311 • Pesanan #RLV-2063</p>
                ...
                <div class="bg-surface-container-low border border-muted-border rounded-lg p-4 mb-4">
                    <p class="font-body-md text-sm text-on-surface-variant">"Sudah 7 hari belum sampai, estimasi awalnya 3 hari." — <span class="text-on-surface font-bold">Andi Pratama</span></p>
                ...
                <div class="flex gap-3">
                    <button class="flex-1 py-2.5 border border-muted-border text-on-surface font-label-sm text-label-sm uppercase tracking-widest rounded hover:bg-surface-container-low transition-colors">Lihat Percakapan</button>
                </div>
            </div>
        </div>
    </section>
