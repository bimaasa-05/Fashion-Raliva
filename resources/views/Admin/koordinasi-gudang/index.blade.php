        ...
        <div class="space-y-gutter">
            ...
            <div class="border border-muted-border rounded-lg p-5 flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div class="flex gap-3 shrink-0">
                    <form method="POST" action="{{ route('admin.koordinasi-gudang.setujui', $t->stock_transfer_id) }}">
                        @csrf
            ...
            <div id="modal-tolak-{{ $t->stock_transfer_id }}" data-modal class="fixed inset-0 z-[70] hidden flex items-center justify-center p-4">
                <div class="absolute inset-0 bg-black/50" data-modal-close></div>
                <form method="POST" action="{{ route('admin.koordinasi-gudang.tolak', $t->stock_transfer_id) }}" class="relative mx-auto w-full max-w-sm bg-surface-container-lowest border border-muted-border rounded-xl shadow-xl p-6">
                    @csrf
