@php
    ...
    $sidebarBadges = \App\Support\ProduksiBadgeCounter::counts();
    $menuGroups = [
        [
            'label' => 'Utama',
            'items' => [
        ...
        [
            ...
            'items' => [
                ['route' => 'produksi.data-produksi', 'icon' => 'precision_manufacturing', 'text' => 'Data Produksi', 'badge' => 'produksi'],
                ['route' => 'produksi.pemeriksaan-kualitas', 'icon' => 'fact_check', 'text' => 'Pemeriksaan Kualitas', 'badge' => 'qc'],
                ['route' => 'produksi.produk-selesai', 'icon' => 'task_alt', 'text' => 'Produk Selesai', 'badge' => 'siap_kirim'],
        ...
        [
            ...
            'items' => [
                ...
                ['route' => 'produksi.permintaan', 'icon' => 'send', 'text' => 'Permintaan', 'badge' => 'permintaan'],
                ['route' => 'produksi.notifikasi', 'icon' => 'notifications', 'text' => 'Notifikasi', 'badge' => 'notifikasi'],
            ],
        ],
        [
            'label' => 'Akun',
...
<script>
(function () {
    if (window.__ralivaSidebarBadgesProduksi) return;
    window.__ralivaSidebarBadgesProduksi = true;
    ...
    async function refresh() {
        ...
        busy = true;
        try {
            const res = await fetch('{{ route('produksi.sidebar-badges') }}', {
