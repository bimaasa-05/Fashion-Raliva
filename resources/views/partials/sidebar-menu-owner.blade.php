@php
    ...
    $sidebarBadges = \App\Support\OwnerBadgeCounter::counts();
    $menuGroups = [
        [
            'label' => 'Utama',
            'items' => [
        ...
        [
            ...
            'items' => [
                ...
                ['route' => 'owner.paket-slot', 'icon' => 'card_membership', 'text' => 'Paket Slot'],
                ['route' => 'owner.peringkat-iklan', 'icon' => 'workspace_premium', 'text' => 'Iklan Peringkat'],
                ['route' => 'owner.gudang', 'icon' => 'swap_horiz', 'text' => 'Pemindahan Stok', 'badge' => 'gudang'],
            ],
        ],
        [
            'label' => 'Penjualan',
        ...
        [
            ...
            'items' => [
                ...
                ['route' => 'owner.pencairan-dana', 'icon' => 'payments', 'text' => 'Pencairan Dana', 'badge' => 'penarikan'],
            ],
        ],
        [
            'label' => 'Tim & Laporan',
...
<script>
(function () {
    if (window.__ralivaSidebarBadgesOwner) return;
    window.__ralivaSidebarBadgesOwner = true;
    ...
    async function refresh() {
        ...
        busy = true;
        try {
            const res = await fetch('{{ route('owner.sidebar-badges') }}', {
