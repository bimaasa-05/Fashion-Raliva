                    ...
                    <div>
                        ...
                        <div class="relative" data-cs>
                            <button type="button" data-cs-trigger aria-haspopup="listbox" aria-expanded="false"
                                class="w-full flex items-center justify-between gap-2 bg-surface-container-lowest border border-muted-border rounded-lg px-3 py-2.5 font-body-md text-sm text-left text-on-surface cursor-pointer focus:outline-none focus:border-gold-accent transition-colors">
