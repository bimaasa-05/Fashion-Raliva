...
<div class="px-container-margin flex-grow">
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-gutter gap-y-container-margin">
        <div class="group cursor-pointer flex flex-col" onclick="openDetailModal()">
            <div class="relative w-full aspect-[3/4] bg-surface-container-low mb-element-gap overflow-hidden">
