...
@component('SuperAdmin.partials.premium-modal', [
    ...
    <form method="POST" action="" id="kategori-form" onsubmit="closeKategoriModal()">
        ...
        <div class="flex flex-col-reverse sm:flex-row sm:justify-end gap-4 pt-2">
            ...
            <button type="submit" id="kategori-submit-btn" class="btn-modal btn-modal-primary">Tambah Kategori</button>
        </div>
    </form>
@endcomponent
...
@component('SuperAdmin.partials.premium-modal', [
    ...
    <form method="POST" action="" id="kategori-toko-form" onsubmit="closeKategoriTokoModal()">
        ...
        <div class="flex flex-col-reverse sm:flex-row sm:justify-end gap-4 pt-2">
            ...
            <button type="submit" id="kategori-toko-submit-btn" class="btn-modal btn-modal-primary">Tambah Kategori Toko</button>
        </div>
    </form>
@endcomponent
