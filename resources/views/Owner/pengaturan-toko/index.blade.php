    ...
    <form data-toast-message="Pengaturan toko berhasil disimpan." data-reveal-group>
        ...
        <section data-reveal class="bg-surface-container-lowest border border-muted-border rounded-lg p-6 card-premium mt-section-gap">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-gutter">
                @foreach ([['shopping_bag', 'Pesanan Baru', 'Email & push saat ada pesanan masuk.', true], ['account_balance_wallet', 'Perubahan Saldo', 'Info saldo masuk, tertunda, dan pencairan.', true], ['star', 'Ulasan Baru', 'Push notifikasi untuk ulasan 1–2 bintang.', false], ['support_agent', 'Komplain Customer', 'Prioritas tinggi, langsung ke email Owner.', true], ['inventory_2', 'Stok Menipis', 'Peringatan ketika stok < 10 unit.', false], ['verified', 'Status Moderasi Produk', 'Kabarnya produk disetujui atau ditolak.', true]] as $notif)
