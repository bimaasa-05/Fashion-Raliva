    ...
    <section>
        ...
        <div data-reveal-group class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-section-gap">
            @foreach ([
                ...
                ['kode' => 'CASHBACK50', 'nama' => 'Cashback Raliva Pay', 'tipe' => 'Cashback Rp 50rb', 'maks' => 'Maks. Rp 50rb', 'min' => 'Via Raliva Pay', 'periode' => '01 — 31 Jul 2026', 'terpakai' => 74, 'kuota' => 80, 'status' => 'nonaktif', 'sisa' => 'dinonaktifkan manual'],
            ] as $promo)
