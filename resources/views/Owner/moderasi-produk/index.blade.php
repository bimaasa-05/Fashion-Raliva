    ...
    <section data-table-scope>
        ...
        <div data-reveal-group class="space-y-gutter">
            @foreach ([
                ...
                ['nama' => 'Silk Scarf Monogram', 'sku' => 'RLV-SSM-002', 'versi' => 'Restock + foto baru', 'tgl' => '16 Agu 2026', 'status' => 'pending', 'catatan' => 'Antrian review ke-2. Estimasi selesai besok pagi.', 'ikon' => 'schedule'],
