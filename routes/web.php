...
use App\Http\Controllers\SuperAdmin\ManajemenRoleController;
...
Route::prefix('superadmin')->name('superadmin.')->middleware(['auth', 'role:Super Admin'])->group(function () {
    ...
    Route::post('/manajemen-role', [ManajemenRoleController::class, 'store'])->name('manajemen-role.store');
    Route::put('/manajemen-role/{role}', [ManajemenRoleController::class, 'update'])->name('manajemen-role.update');
    Route::put('/manajemen-role/{role}/toggle-status', [ManajemenRoleController::class, 'toggleStatus'])->name('manajemen-role.toggle-status');
    Route::get('/manajemen-role/{role}', [ManajemenRoleController::class, 'detail'])->name('manajemen-role.detail');
    Route::put('/manajemen-role/{role}/permissions', [ManajemenRoleController::class, 'updatePermissions'])->name('manajemen-role.permissions.update');
