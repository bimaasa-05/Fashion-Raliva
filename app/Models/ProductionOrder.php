...
class ProductionOrder extends Model
{
    ...
    protected function prioritas(): Attribute
    {
        return Attribute::make(
            get: fn (?string $value) => $value === 'sedang' ? self::PRIORITAS_NORMAL : $value,
            set: fn (?string $value) => $value === 'sedang' ? self::PRIORITAS_NORMAL : $value,
        );
    }
